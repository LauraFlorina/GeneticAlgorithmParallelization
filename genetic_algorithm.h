...
// realizeaza merge, luand din vectorul sursa de la start la mid si de la mid la end
// si adaugand in destinatie
void merge(individual *sourse, int start, int mid, int end, individual *destination);

// apeleaza functia merge cu diferiti parametrii in functie de numarul threadurilor
